                            ...
                            beachReviewReference.setValue(true).
                                    addOnCompleteListener(beachTask -> {
                                        if (beachTask.isSuccessful()) {
                                            Toast.makeText(EditReviewActivity.this, "Review linked to beach successfully", Toast.LENGTH_SHORT).show();
                                        }else {
                                            Toast.makeText(EditReviewActivity.this, "Failed to link review to beach", Toast.LENGTH_SHORT).show();
                                        }
                                    } );
                        }else {
                            Toast.makeText(EditReviewActivity.this, "Failed to post review", Toast.LENGTH_SHORT).show();
                        }
                    });
        }else {
            Toast.makeText(EditReviewActivity.this, "Error generating review ID", Toast.LENGTH_SHORT).show();
        }
