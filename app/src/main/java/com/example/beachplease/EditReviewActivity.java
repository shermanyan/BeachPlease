...
//                        updateDatabase(reviewId, rating, reviewText); // Pass reviewId to updateDatabase
////                        Toast.makeText(EditReviewActivity.this, "Review posted successfully", Toast.LENGTH_SHORT).show();
//                        finish();
//                    }
//
//                    @Override
...
//            // Delete the review if the text field is empty
//            reviewReference.removeValue()
//                    .addOnSuccessListener(aVoid -> Toast.makeText(this, "Review deleted successfully", Toast.LENGTH_SHORT).show())
//                    .addOnFailureListener(e -> Toast.makeText(this, "Failed to delete review", Toast.LENGTH_SHORT).show());
//        } else {
//            // Update reviewText and stars fields if text is provided
...
//        }
//
//        // Close the activity after the operation
//        finish();
//    }
//
//}
